-- BenedictJeromeMart - Full Schema (idempotent, PostgreSQL-compatible)
-- Used automatically when the database URL is jdbc:postgresql:...
-- Identity counters are synced by AppContextListener after this runs.
